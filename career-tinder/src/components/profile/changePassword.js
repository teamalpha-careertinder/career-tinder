                ...
                <ul className="nav nav-pills mb-3" id="pills-tab" role="tablist">
                  <li className="nav-item">
                    {user && user.userType === "jobseeker" ?
                      ...
                      :
                      <a className="nav-link active" id="pills-company-tab" data-toggle="pill" href="#pills-company" role="tab" aria-controls="pills-company" aria-selected="false">
                        ...
                        <div className="col-md-6 col-sm-12">
                          <div className="form-group">
                            <MDBInput
                                ...
                                label="Enter new Password" type="password" icon="pencil-alt" />
                          </div>
                        </div>                      
                        <div className="col-md-6 col-sm-12">
                          <div className="form-group">
                          <MDBInput
                                ...
                                value={passwordTwo}
                                onChange={this.handleChange}
                                label="Re-enter new Password" type="password" icon="pencil-alt" />
                          </div>
                        </div>
                      </div>
                      <div className="row">
                        <div className="col-sm-12">
                          <MDBBtn outline color="info" className="float-right" href="/#/profile/create"> 
                            Back to profile
                          </MDBBtn>
